...
SWEP.PrintName="OSISB"
if CLIENT then language.Add("weapon_stunstick","OSISB") end
SWEP.Instructions="Primary to swing."
SWEP.Purpose="Overwatch Standart Issue Stun-Baton."
...
function SWEP:PrimaryAttack()
	...
	self.IsMelee=yes
	for i=0,1,0.2 do timer.Simple((i/5),function() if IsValid(self)&&IsValid(owner) then
